...
{
public:
    explicit EnCryptOp(OpKernelConstruction *context) : OpKernel(context)
    {
...
REGISTER_KERNEL_BUILDER(Name("EnCrypt").Device(DEVICE_CPU), EnCryptOp);

class EnCryptGradOp : public OpKernel
{
public:
    explicit EnCryptGradOp(OpKernelConstruction *context) : OpKernel(context)
    {
        OP_REQUIRES_OK(context, context->GetAttr("eid_low", &eid_low_));
        OP_REQUIRES_OK(context, context->GetAttr("eid_high", &eid_high_));
        OP_REQUIRES_OK(context, context->GetAttr("times", &times_));
...
REGISTER_KERNEL_BUILDER(Name("EnCryptGrad").Device(DEVICE_CPU), EnCryptGradOp);
